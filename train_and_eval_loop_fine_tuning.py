...
# Dataset.
flags.DEFINE_string(name='dataset', default='NIH', help='dataset.')
...
flags.DEFINE_string(name='optim_type', default='Admaw', help='optimizer type.')
flags.DEFINE_string(
    name='sched_type',
    default='halfcos',
...
flags.DEFINE_float(name='learning_rate', default=0.001, help='learning rate.')
flags.DEFINE_float(
    name='weight_decay',
    default=0.0001,
...
flags.DEFINE_integer(name='num_epoch', default=20, help='number of epoch.')
flags.DEFINE_integer(
    name='num_generation',
    default=15,
