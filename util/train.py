...
class BaseTrain(object):
  ...
  def get_dataset(self, **kwargs):
    """Gets dataset."""
    if self.dataset == 'NIH10':
      return dataloader.NIH10()
    elif self.dataset == 'OpenI':
      return dataloader.OpenI()(kwargs.get('class_im_ratio', 1))
    else:
  ...
  def get_train_step_fn(self):
    ...
    def step_fn(data):
      ...
      with tf.GradientTape() as tape:
        ...
        loss_xe = tf.keras.losses.contrast(y, logits, from_logits=True)
        loss_xe = tf.divide(
